...
AjaxSolr.AbstractTextWidget = AjaxSolr.AbstractWidget.extend(
  ...
  set: function (q) {
    return this.changeSelection(function () {
      this.manager.store.get('q').val(q);  //Returns a parameter. If the parameter doesn't exist, creates it.
    });
  },
  ...
  clear: function () {
    return this.changeSelection(function () {
      this.manager.store.remove('q');  //Deletes a parameter
    });
  },
  ...
  changeSelection: function (func) {
    var before = this.manager.store.get('q').val(); //Returns the q parameter
    func.apply(this);
